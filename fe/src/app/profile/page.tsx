    ...
    return (
        <div className="max-w-4xl mx-auto mt-6 px-4 space-y-8">
            ...
            <div className="flex items-center justify-between">
                ...
                <button className="bg-gray-200 hover:bg-gray-300 cursor-pointer text-gray-800 font-semibold px-4 py-2 rounded-lg transition duration-200">
                    Chỉnh sửa
                </button>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white p-6 rounded-xl shadow-md">
                ...
                <div>
                    <h2 className="text-xl font-semibold">{user?.data?.User?.fullName}</h2>
